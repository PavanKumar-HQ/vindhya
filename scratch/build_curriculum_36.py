...
s1_left = """
  <div class="slide-content-box center-aligned">
    ...
    <div class="slide-visual-media mt-2">
      <img src="assets/hero_learning_loop.jpg" alt="AI & Human Cognitive Loop" class="slide-presentation-img" style="max-height: 230px; object-fit: contain;">
    </div>
    <div class="slide-footer-tag mt-3">Karnataka State Board &bull; Classes 9 &amp; 10</div>
  </div>
"""
s1_right = """
  <div class="panel-header-strip">
    <span class="panel-tag tag-pink">ICEBREAKER AUDIENCE POLL</span>
  </div>
  <div class="panel-title-area">
    <h3 class="panel-heading">BE HONEST... WE WON'T TELL YOUR TEACHER 🤫</h3>
  </div>
  <div class="panel-body-content">
    <div class="bullet-list-editorial">
      <div class="bullet-item">
        <div class="bullet-icon bg-yellow">🙋‍♂️</div>
        <div class="bullet-text">
          <strong>Question 1: Hands in the Air!</strong>
          <span class="bullet-sub">How many of you have used ChatGPT to finish homework in 30 seconds? Be honest!</span>
        </div>
      </div>
      <div class="bullet-item">
        <div class="bullet-icon bg-cyan">🎯</div>
        <div class="bullet-text">
          <strong>Question 2: Keep Hands Up IF...</strong>
          <span class="bullet-sub">You actually understood what you submitted and could answer it in an exam right now?</span>
        </div>
      </div>
    </div>
    <div class="retention-meter-card mt-3">
      <div class="meter-header">
        <span class="meter-label">HANDS REMAINING IN THE AIR</span>
        <span class="meter-value">UNDER 10%</span>
      </div>
      <div class="meter-bar">
        <div class="meter-fill" style="width: 8%;"></div>
      </div>
      <p class="meter-caption">Almost all hands drop! Using AI to bypass homework creates zero exam readiness.</p>
    </div>
  </div>
  <div class="panel-footer-meta">
    <span class="kid-badge badge-yellow">REALITY CHECK: Copying AI ≠ Learning</span>
  </div>
"""
slides.append(make_slide(0, "0–15 MIN • PART 1: AI FOR EXAMS", "OPENING &bull; BE HONEST", s1_left, s1_right))

# =========================================================================
# SLIDE 02: THE RELATABLE NIGHTMARE
# =========================================================================
s2_left = """
  <div class="panel-header-strip">
    <span class="panel-tag tag-red">THE RELATABLE NIGHTMARE</span>
  </div>
  <div class="panel-title-area">
    <h3 class="panel-heading">SUNDAY NIGHT. 10:30 PM. EXAM IN 7 DAYS.</h3>
  </div>
  <div class="panel-body-content">
    <div class="bullet-list-editorial">
      <div class="bullet-item">
        ...
        <div class="bullet-text">
          <strong>4 Huge Science Chapters Remaining</strong>
          <span class="bullet-sub">Textbook open on your desk. Words are swimming. Clock ticking relentlessly.</span>
        </div>
      </div>
      <div class="bullet-item">
        <div class="bullet-icon bg-yellow">😵</div>
        <div class="bullet-text">
          <strong>Dense Jargon Overload</strong>
          <span class="bullet-sub">"The rate of change of momentum is proportional to the impressed force..." What does that even mean?!</span>
        </div>
      </div>
    </div>
    <div class="panic-meter-strip mt-3">
      <span class="strip-label">STRESS LEVEL:</span>
      <span class="strip-badge badge-red">🚨 95% PANIC</span>
    </div>
  </div>
  <div class="panel-footer-meta">
    <span class="kid-badge badge-red">SCENARIO: Every student in Karnataka has been here</span>
  </div>
"""
s2_right = """
  <div class="panel-header-strip">
    <span class="panel-tag tag-cyan">THE MEMORISATION TRAP</span>
  </div>
  <div class="panel-title-area">
    <h3 class="panel-heading">REREADING GIVES A FAKE SENSE OF SECURITY</h3>
  </div>
  <div class="panel-body-content">
    <div class="bullet-list-editorial">
      <div class="bullet-item">
        <div class="bullet-icon bg-yellow">👁️</div>
        <div class="bullet-text">
          <strong>Eyes Moving ≠ Brain Learning</strong>
          <span class="bullet-sub">Reading a page 5 times feels like studying, but recognition is NOT recall.</span>
        </div>
      </div>
      <div class="bullet-item">
        <div class="bullet-icon bg-red">📉</div>
        <div class="bullet-text">
          <strong>The Forgetting Curve Disaster</strong>
          <span class="bullet-sub">Without active processing, 82% of crammed definitions vanish before exam day.</span>
        </div>
      </div>
    </div>
    <div class="retention-meter-card mt-3">
      <div class="meter-header">
        <span class="meter-label">EXAM RETENTION AFTER 48 HOURS (PASSIVE REREADING)</span>
        <span class="meter-value">18%</span>
      </div>
      <div class="meter-bar">
        <div class="meter-fill" style="width: 18%;"></div>
      </div>
      <p class="meter-caption">In the exam hall, the question is twisted slightly and the mind goes blank!</p>
    </div>
  </div>
  <div class="panel-footer-meta">
    <span class="kid-badge badge-yellow">THE SOLUTION: Active AI Interaction</span>
  </div>
"""
slides.append(make_slide(1, "0–15 MIN • PART 1: AI FOR EXAMS", "THE REAL QUESTION &bull; EXAM IN 7 DAYS", s2_left, s2_right))

# =========================================================================
# SLIDE 03: WHAT'S YOUR MOVE?
# =========================================================================
s3_left = """
  <div class="panel-header-strip">
  ...
  <div class="panel-title-area">
    <h3 class="panel-heading">WHEN YOU ARE STUCK... WHAT'S YOUR MOVE?</h3>
  </div>
  <div class="panel-body-content">
    <p class="mb-2"><strong>Shout your letter!</strong> When a Science concept makes zero sense at night:</p>
    <div class="interactive-poll-grid">
      <div class="option-card" onclick="castAudienceVote(this, 12)">
        <span class="option-badge">A</span>
        <div class="option-content">
          <strong>Reread textbook 10 times</strong>
          <span>Stare at the page hoping magic happens</span>
        </div>
      </div>
      <div class="option-card" onclick="castAudienceVote(this, 18)">
        <span class="option-badge">B</span>
        <div class="option-content">
          <strong>Copy guide answers blindly</strong>
          <span>Rote memorise keywords without understanding</span>
        </div>
      </div>
      <div class="option-card" onclick="castAudienceVote(this, 24)">
        <span class="option-badge">C</span>
        <div class="option-content">
          <strong>Panic &amp; scroll YouTube/Insta</strong>
          <span>Give up and feel guilty at 1 AM</span>
        </div>
      </div>
      <div class="option-card highlight-card" onclick="castAudienceVote(this, 84)">
        <span class="option-badge badge-cyan">D</span>
        <div class="option-content">
          <strong>Use AI the RIGHT way</strong>
          <span>Make AI tutor, practice &amp; test you</span>
        </div>
      </div>
    </div>
  </div>
...
s3_right = """
  ...
  <div class="panel-title-area">
    <h3 class="panel-heading">WHAT IF OPTION D WAS YOUR SECRET WEAPON?</h3>
  </div>
  <div class="panel-body-content">
    <div class="bullet-list-editorial">
      <div class="bullet-item">
        ...
        <div class="bullet-text">
          <strong>Private 24/7 Teacher Sitting Next to You</strong>
          <span class="bullet-sub">Never gets tired, never judges you, explains 10 different ways until you get it.</span>
        </div>
      </div>
      <div class="bullet-item">
        <div class="bullet-icon bg-yellow">🥊</div>
        <div class="bullet-text">
          <strong>An Unforgiving Exam Sparring Partner</strong>
          <span class="bullet-sub">Tests you with board-level questions before the real examiner sees your paper.</span>
        </div>
      </div>
      <div class="bullet-item">
        <div class="bullet-icon bg-pink">📝</div>
        <div class="bullet-text">
          <strong>Strict Board Examiner Feedback</strong>
          <span class="bullet-sub">Marks your drafts, catches missing scientific keywords, and shows how to get full marks.</span>
        </div>
      </div>
    </div>
  </div>
  <div class="panel-footer-meta">
    <span class="kid-badge badge-green">TODAY: You master Option D</span>
  </div>
"""
slides.append(make_slide(2, "0–15 MIN • PART 1: AI FOR EXAMS", "WHAT'S YOUR MOVE? &bull; WHAT IF D WAS DIFFERENT?", s3_left, s3_right))

# =========================================================================
# SLIDE 04: THE #1 WORKSHOP LAW
# =========================================================================
s4_left = """
  <div class="panel-header-strip">
    <span class="panel-tag tag-yellow">GOLDEN RULE</span>
  </div>
  <div class="panel-title-area">
    <h3 class="panel-heading">THE #1 WORKSHOP LAW</h3>
  </div>
  <div class="panel-body-content">
    <div class="quote-callout-box">
      <blockquote class="slide-blockquote">
        “AI is a bicycle for your brain &mdash; NOT a wheelchair.”
      </blockquote>
      <p class="quote-explanation">If AI pedals for you, your mental muscles become weak. If AI coaches you to pedal faster, you win the race.</p>
    </div>
    <div class="bullet-list-editorial mt-2">
      <div class="bullet-item">
        <div class="bullet-icon bg-red">🚫</div>
        <div class="bullet-text">
          <strong>Lazy Use (AI Learns, You Don't)</strong>
          <span class="bullet-sub">Asking AI to generate an essay/answer and copying it. Zero memory formed.</span>
        </div>
      </div>
      <div class="bullet-item">
        <div class="bullet-icon bg-green">⚡</div>
        <div class="bullet-text">
          <strong>Master Use (You Learn, AI Coaches)</strong>
          <span class="bullet-sub">Using AI to explain, challenge, drill, and audit YOUR thinking.</span>
        </div>
      </div>
    </div>
  </div>
  <div class="panel-footer-meta">
    <span class="kid-badge badge-yellow">GENIUSPHERE LAW: Think First &bull; AI Second</span>
  </div>
"""
s4_right = """
  <div class="panel-header-strip">
    <span class="panel-tag tag-cyan">EXAM COMPARISON</span>
  </div>
  <div class="panel-title-area">
    <h3 class="panel-heading">PASSIVE CONSUMER VS ACTIVE MASTER</h3>
  </div>
  <div class="panel-body-content">
    <div class="comparison-card">
      <div class="compare-col bad-col">
        <div class="compare-badge badge-bad">❌ PASSIVE CONSUMER</div>
        <p><strong>Method:</strong> "ChatGPT, write 5-mark answer for Ohm's Law."</p>
        <p><strong>Action:</strong> Copy-pastes into notebook.</p>
        <p><strong>Brain State:</strong> 100% asleep.</p>
        <p><strong>Board Exam Result:</strong> Blanks out when questions are phrased differently.</p>
      </div>
      <div class="compare-versus-badge">VS</div>
      <div class="compare-col good-col">
        <div class="compare-badge badge-good">✅ ACTIVE MASTER</div>
        <p><strong>Method:</strong> "Explain Ohm's Law using water pipes, then quiz me!"</p>
        <p><strong>Action:</strong> Types own answer and asks AI to mark it.</p>
        <p><strong>Brain State:</strong> 100% engaged.</p>
        <p><strong>Board Exam Result:</strong> Full marks on application questions!</p>
      </div>
    </div>
  </div>
  <div class="panel-footer-meta">
    <span class="kid-badge badge-green">WHICH STUDENT WILL YOU BE TODAY?</span>
  </div>
"""
slides.append(make_slide(3, "0–15 MIN • PART 1: AI FOR EXAMS", "THE AI STUDY PARTNER &bull; OUR RULE", s4_left, s4_right))

# =========================================================================
# SLIDE 05: CURRICULUM OVERVIEW (7 SKILLS)
# =========================================================================
s5_left = """
  <div class="panel-header-strip">
    <span class="panel-tag tag-pink">CURRICULUM BLUEPRINT</span>
  </div>
  <div class="panel-title-area">
    <h3 class="panel-heading">THE 7 CORE SKILLS YOU WILL MASTER TODAY</h3>
  </div>
  <div class="panel-body-content">
    <div class="roadmap-grid-compact">
      <div class="roadmap-pill"><span class="step-num bg-yellow">1</span> <strong>UNDERSTAND</strong> (ChatGPT/Gemini &rarr; Concepts)</div>
      <div class="roadmap-pill"><span class="step-num bg-cyan">2</span> <strong>PRACTISE</strong> (Exam questions &amp; quizzes)</div>
      <div class="roadmap-pill"><span class="step-num bg-pink">3</span> <strong>CHECK</strong> (Evaluate your own answers)</div>
      <div class="roadmap-pill"><span class="step-num bg-green">4</span> <strong>IMPROVE</strong> (Fix mistakes &amp; rewrite)</div>
      <div class="roadmap-pill"><span class="step-num bg-yellow">5</span> <strong>STUDY YOUR MATERIAL</strong> (NotebookLM + Textbook)</div>
      <div class="roadmap-pill"><span class="step-num bg-cyan">6</span> <strong>ASK BETTER</strong> (5-Part Prompting formula)</div>
      <div class="roadmap-pill"><span class="step-num bg-red">7</span> <strong>VERIFY</strong> (STOP &rarr; CHECK &rarr; THINK)</div>
    </div>
  </div>
  <div class="panel-footer-meta">
    <span class="kid-badge badge-pink">THE COMPLETE EXAM PREPARATION STACK</span>
  </div>
"""
s5_right = """
  <div class="panel-header-strip">
    <span class="panel-tag tag-green">WORKSHOP TIMELINE</span>
  </div>
  <div class="panel-title-area">
    <h3 class="panel-heading">STAGE DEMO &rarr; HANDS-ON COMPUTER LAB</h3>
  </div>
  <div class="panel-body-content">
    <div class="timeline-box">
      <div class="timeline-block block-auditorium">
        <div class="timeline-badge bg-yellow">PHASE 1 &bull; 45 MIN</div>
        <h4>AUDITORIUM STAGE: I TEACH &amp; DEMONSTRATE</h4>
        <p>Live demonstrations on the big screen. Terrible prompts vs Master prompts. Head-to-head AI battles. You see exactly how it works.</p>
      </div>
      <div class="timeline-block block-lab mt-2">
        <div class="timeline-badge bg-cyan">PHASE 2 &bull; 60 MIN</div>
        <h4>COMPUTER LAB: YOU SIT AT KEYBOARDS &amp; DO!</h4>
        <p>Every student gets a PC. 7 hands-on missions. You execute the prompts, test your textbook chapters, and earn your certification.</p>
      </div>
    </div>
  </div>
  <div class="panel-footer-meta">
    <span class="kid-badge badge-green">ACTION OVER TALK: Zero passive watching!</span>
  </div>
"""
slides.append(make_slide(4, "0–15 MIN • PART 1: AI FOR EXAMS", "THE 7-SKILL ROADMAP &bull; WHAT YOU LEARN", s5_left, s5_right))

# =========================================================================
# MODULE 1: CHATGPT UNDERSTAND DIFFICULT CONCEPTS (SLIDES 06 - 09)
# =========================================================================
